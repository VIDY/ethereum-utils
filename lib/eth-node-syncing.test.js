...
describe('eth-node-syncing.js', () => {
  ...
  describe('ethNodeSyncing.integerize', () => {
    it('should convert base 16 to integers', () => {
      assert.deepEqual(ethNodeSyncing.integerize({ten: '0xA', fourhundred: '0x190'}), {ten: 10, fourhundred: 400})
    })

    it('should copy non-integers', () => {
      assert.deepEqual(
        ethNodeSyncing.integerize({object: {hello: 'hello'}, array: ['one','two'], string: 'string', fourhundred: '0x190'}),
        {object: {hello: 'hello'}, array: ['one','two'], string: 'string', fourhundred: 400}
      )
    })
  })
})
